...
/**
 * Compressed word2vec-like format word vectors (previously quantized Quantizer).  
 ...
 *
 * Example command:
 * mvn exec:java -Dexec.mainClass=com.scienceminer.grisp.nerd.embeddings.EfficientWord2VecCompress 
